...
@section('title', 'Użytkownicy – ' . config('app.name'))
...
<div class="page-content page-content--wide">
    ...
    @if($items->isEmpty())
        <p class="empty-state">Brak użytkowników. <a href="{{ route('users.create') }}">Dodaj pierwszego użytkownika</a>.</p>
    @else
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-actions">
                            <a href="{{ route('users.edit', $item) }}" class="btn-icon" title="Edytuj">
                            ...
                            <form action="{{ route('users.destroy', $item) }}" method="POST" class="inline-form" onsubmit="return confirm('Usunąć tego użytkownika?');">
                                @csrf
                                @method('DELETE')
